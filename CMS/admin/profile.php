...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                <div class="col-mid-2" style="margin-left: -15px;">
                    <?php 
                    include("sidenav.php");
                    ?>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php 
                                echo "<img src='img/$profiles' class='col-md-12' style='height: 250px; width: 270px;'>";
                                ?>
                            ...
                            <div class="col-md-6">
                                ...
                                if (isset($_POST['update_pass'])) {
                                    ...
                                    if (count($error)==0) {
                                        $querry = "UPDATE admin SET password='$new_pass' WHERE username='$ad'";
